...
// Outputs the position weight matrix for each cluster.
void outputPositionWeightMatrix(const std::string& filename, const std::vector<std::shared_ptr<cluster>>& clusters);
}

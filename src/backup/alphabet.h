...
extern UINT8 asc2dnaOrCol[];
/// Convert a pair of DNA masks to a color mask
extern UINT8 dnamasks2colormask[16][16];
...
extern void setIupacsCat(UINT8 cat);
}
#endif /*ALPHABETS_H_*/

...
BARTENDERSINGLESOURCES	= ./src/barcodemutationgenerator.cpp ./src/barcodetabledumper.cpp ./src/centerclustermapper.cpp ./src/centerhistogramgenerator.cpp ./src/centerrecalibrator.cpp ./src/barcodecluster.cpp ./src/clusteralgorithm.cpp ./src/clustercenterlinkgenerator.cpp ./src/clusteringwithtest.cpp ./src/clustermergerpooltester.cpp ./src/clustermergertester.cpp ./src/clustermergerunpooltester.cpp ./src/clusteroutput.cpp ./src/clustersplitter.cpp ./src/clustertabledumper.cpp ./src/distanceselector.cpp ./src/errorrateestimator.cpp ./src/hypothesistester.cpp ./src/idgenerator.cpp ./src/kmers_dictionary.cpp ./src/bartender_single.cpp ./src/meansequentialestimator.cpp ./src/mergebycenters.cpp ./src/mixturebptester.cpp ./src/proportionpooltest.cpp ./src/proportiontest.cpp ./src/qualitytabledumper.cpp ./src/seedselector.cpp ./src/util.cpp ./src/centerclustermapperiterator.cpp ./src/clustermergeronesampletester.cpp ./src/oneproportiontest.cpp ./src/clusterpruner.cpp ./src/meanestimator.cpp ./src/pcrprocessor.cpp ./src/rawbarcodeloader.cpp ./src/barcodepool.cpp ./src/clusteringdriver.cpp ./src/clustersbucketer.cpp ./src/barcodeindexer.cpp ./src/threadwrapper.cpp ./src/clusterThreadBatcher.cpp ./src/barcodepoolstatistics.cpp ./src/errorestimator.cpp
